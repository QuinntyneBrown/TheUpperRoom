// BUG-065: hackathon-edit not-found is just a <p>; the symmetrical
// contact-edit and partner-edit not-found states use <h1> + a back
// link. Match for cross-feature consistency.
import { test, expect } from '../../fixtures';

test.describe('Hackathon-edit not-found state', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await page.goto('/hackathons/missing/edit');
  ...
  test('not-found heading is rendered as an h1', async ({ page }) => {
    const heading = page.locator('[data-testid="hackathon-edit-not-found"] h1');
