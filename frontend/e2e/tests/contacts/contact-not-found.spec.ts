// Traces to: Contact detail page — not found state
// T53: navigating to a non-existent contact shows a not-found message
import { test, expect } from '../../fixtures';

const DEV_ENABLED = process.env['CI'] !== 'true' || process.env['DEV_E2E'] === 'true';

test.describe('Contact not found', () => {
  ...
  test('shows not-found state for unknown contact id', async ({ auth, page }) => {
    ...
    await page.goto('/contacts/nonexistent-id');
