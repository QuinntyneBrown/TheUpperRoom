...
@Component({
  ...
  styles: [`
    ...
    .global-teams-page__header {
      ...
      padding: 16px 20px; border-bottom: 1px solid var(--ur-border-subtle, #222233);
    ...
    .global-teams-page__search { padding: 12px 20px; border-bottom: 1px solid var(--ur-border-subtle, #222233); }
    ...
    .teams-table th, .teams-table td { padding: 10px 16px; text-align: left; font-size: 0.875rem; border-bottom: 1px solid var(--ur-border-subtle, #222233); }
    ...
    .global-teams-page__total { margin: 0; padding: 10px 20px; font-size: 0.8125rem; color: var(--ur-fg-muted, #64748b); border-top: 1px solid var(--ur-border-subtle, #222233); }
    ...
    .teams-loading__row { height: 40px; border-radius: 6px; background: var(--ur-border-default, #2a2a3a); animation: teams-pulse 1.4s ease-in-out infinite; }
