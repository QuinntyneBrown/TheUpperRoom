...
@Component({
  ...
  styles: [`
    ...
    .partner-detail__permission-banner mat-icon { font-size: 18px; width: 18px; height: 18px; flex-shrink: 0; margin-top: 1px; }
    .partner-detail__permission-banner-body { display: flex; flex-direction: column; gap: 2px; flex: 1; }
    .partner-detail__permission-banner-title { font-weight: 600; }
    .partner-detail__permission-banner-text { font-size: 0.8125rem; opacity: 0.85; }
    ...
    .partner-history__timeline { display: flex; flex-direction: column; gap: 12px; list-style: none; margin: 0; padding: 0; }
