...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    provideRouter([
      ...
      { path: 'admin/deleted-contacts', title: 'Deleted Contacts – The Upper Room', component: DeletedContactsPageComponent },
      { path: 'admin/deleted-hackathons', title: 'Deleted Hackathons – The Upper Room', component: DeletedHackathonsPageComponent },
